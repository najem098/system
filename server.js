...
`)
 ...
 .setFooter('Developer <@708708508262203502>')
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .setColor("RANDOM")
     .addField('> <a:lod:755109625254379612>  ** PING**' , [`➪ ${Date.now() - message.createdTimestamp}` + ' **ms**'], true)
      .addField("> <:664107320317575190:755109597231972392> **SERVERS** :  ", `➪ ${client.guilds.size} `, true)
      .addField("> <:657700206216740906:755109601820803152> ** CHANNELS** : ", `➪ ${client.channels.size} `, true)
      .addField("> <a:ko:756674594580070481> **USERS** : ", `➪ ${client.users.size} `, true)
      .addField("> <a:651720016651354112:755109590823207043> **DEVLOPER** :  ", `➪ <@708708508262203502>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
  ...
  if (pixelbot.content.startsWith(prefix + "user")) {
    ...
    pixelbot.guild.fetchInvites().then(invites => {
      ...
      let pixeluser = new Discord.RichEmbed() // itzZa1D - Codes Team.
        ...
        .addField("> <a:AO:755109603137683627> **__USER✵NAME :__**    ", pixelbot.author.username, true)
        .addField("> <a:AO:755109603137683627> **__USER✵ID :__** ", pixelbot.author.id, true) // itzZa1D - Codes Team.
        .addField(
...
client.on('message', message => {
    ...
    embed: new Discord.RichEmbed()
       ...
       .setThumbnail('https://cdn.discordapp.com/attachments/755103317801304078/756205327946350762/received_606005716948521.jpeg')
